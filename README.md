...
- **Multi-agent orchestrator** — coordinator mode, 10 worker types (explore, plan, implement, verify, code-review, security, bug-fix, code-research, docs-impl, tests-impl), single mode, live tool call display
...
| 🔎 **code-review** | Diff-only semantic code review: conventions, stack-aware rules, severity-tagged findings, security handoff | Read-only |
