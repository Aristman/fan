...
**Проверить:**
- [x] Сессии отображаются с заголовками
...
- [x] Auto-scroll вниз при новых сообщениях
- [x] Скролл вверх → auto-scroll отключается (не дёргает обратно)
...
- [x] Progress-бары для tokens и cost с корректными значениями
- [x] Цвет прогресс-бара: зелёный <60%, жёлтый 60-85%, красный >85%
