...
|------|--------|-------------|
| `CLAUDE.md` | ✅ | Quick context for LLM sessions, orchestrator rules, CLI commands, test instructions |
| `ARCHITECTURE.md` | ✅ | Comprehensive architecture reference, packages, data flow, API, DB schema |
