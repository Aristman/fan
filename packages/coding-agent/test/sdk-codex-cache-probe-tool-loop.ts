...
import { type AssistantMessage, getModel, Type } from "@seaagents/fan-ai";
...
function buildPrompt(turn: number): string {
	...
	const lines: string[] = [];
	lines.push("This is an automated prompt-cache tool-loop test executed through the fan coding-agent SDK.");
