...
import type { AgentEvent } from "@itone/fan-agent-core";
 ...
 * RPC mode tests.
 */
describe.skipIf(!process.env.ANTHROPIC_AFAN_KEY && !process.env.ANTHROPIC_OAUTH_TOKEN)("RPC mode", () => {
	...
	beforeEach(() => {
		...
		client = new RpcClient({
			...
			cwd: join(__dirname, ".."),
			env: { FAN_CODING_AGENT_DIR: sessionDir },
			provider: "anthropic",
