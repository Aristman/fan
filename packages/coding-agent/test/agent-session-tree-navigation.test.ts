...
import { AFAN_KEY, createTestSession, type TestSessionContext } from "./utilities.js";

describe.skipIf(!AFAN_KEY)("AgentSession tree navigation e2e", () => {
...
describe.skipIf(!AFAN_KEY)("AgentSession tree navigation - branch scenarios", () => {
	let ctx: TestSessionContext;
