...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@itone/fan-tui";
...
const THEME_KEY = Symbol.for("@itone/fan-coding-agent:theme");
...
export function getSettingsListTheme(): import("@itone/fan-tui").SettingsListTheme {
	return {
