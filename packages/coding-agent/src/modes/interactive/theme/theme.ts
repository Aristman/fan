...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@seaagents/fan-tui";
...
const THEME_KEY = Symbol.for("@seaagents/fan-coding-agent:theme");
...
export function getSettingsListTheme(): import("@seaagents/fan-tui").SettingsListTheme {
	return {
