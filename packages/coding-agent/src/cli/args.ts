...
${chalk.bold("Options:")}
  ...
  --host <host>                  Server bind address (default: localhost, falls back to HOST env var, used with --mode server)
...
${chalk.bold("Environment Variables:")}
  ...
  HOST                              - Default server bind address (used when --host is not set)
