...
import { Container, Text, truncateToWidth } from "@itone/fan-tui";
...
function getTempFilePath(): string {
	...
	return join(tmpdir(), `fan-bash-${id}.log`);
}
...
/**
 * Create bash operations using fan's built-in local shell execution backend.
 *
 * This is useful for extensions that intercept user_bash and still want fan's
