...
export function getPackageDir(): string {
	...
	const envDir = process.env.FAN_PACKAGE_DIR;
	if (envDir) {
...
// =============================================================================
// App Config (from package.json fanConfig)
// =============================================================================

const pkg = JSON.parse(readFileSync(getPackageJsonPath(), "utf-8"));

export const APP_NAME: string = pkg.fanConfig?.name || "fan";
export const CONFIG_DIR_NAME: string = pkg.fanConfig?.configDir || ".fan";
export const VERSION: string = pkg.version;

// e.g., FAN_CODING_AGENT_DIR or TAU_CODING_AGENT_DIR
export const ENV_AGENT_DIR = "FAN_CODING_AGENT_DIR";

const DEFAULT_SHARE_VIEWER_URL = "https://fan.dev/session/";

/** Get the share viewer URL for a gist ID */
export function getShareViewerUrl(gistId: string): string {
	const baseUrl = process.env.FAN_SHARE_VIEWER_URL || DEFAULT_SHARE_VIEWER_URL;
	return `${baseUrl}#${gistId}`;
}

// =============================================================================
// User Config Paths (~/.fan/agent/*)
// =============================================================================
