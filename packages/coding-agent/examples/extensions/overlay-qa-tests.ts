...
import type { Component, OverlayAnchor, OverlayHandle, OverlayOptions, TUI } from "@seaagents/fan-tui";
import { matchesKey, truncateToWidth, visibleWidth } from "@seaagents/fan-tui";
...
export default function (fan: ExtensionAPI) {
	// Animation demo - proves overlays can handle real-time updates (like fan-doom would need)
	fan.registerCommand("overlay-animation", {
	...
	fan.registerCommand("overlay-anchors", {
	...
	fan.registerCommand("overlay-margins", {
	...
	fan.registerCommand("overlay-stack", {
	...
	fan.registerCommand("overlay-overflow", {
	...
	fan.registerCommand("overlay-edge", {
	...
	fan.registerCommand("overlay-percent", {
	...
	// Test maxHeight
	fan.registerCommand("overlay-maxheight", {
	...
	fan.registerCommand("overlay-sidepanel", {
	...
	fan.registerCommand("overlay-toggle", {
	...
	fan.registerCommand("overlay-passive", {
	...
	fan.registerCommand("overlay-focus", {
	...
	fan.registerCommand("overlay-streaming", {
	...
	private startProcess(): void {
		...
		this.proc = spawn("bash", [
			...
			for i in $(seq 1 100); do
				...
				DIR="/Users/nicobailon/Documents/development/fan/packages/coding-agent/src/modes/interactive"
				...
				if [ $((i % 5)) -eq 0 ]; then
					echo -e "  \\033[32m✓ Successfully processed \${i} files in /Users/nicobailon/Documents/development/fan\\033[0m"
				fi
				if [ $((i % 7)) -eq 0 ]; then
