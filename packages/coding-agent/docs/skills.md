...
Discovery rules:
- In `~/.fan/agent/skills/` and `.fan/skills/`, direct root `.md` files are discovered as individual skills
...
For project-level Claude Code skills, add to `.fan/settings.json`:
