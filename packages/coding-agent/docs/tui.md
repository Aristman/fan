...
**Source:** [`@itone/fan-tui`](https://github.com/itone/fan-mono/tree/main/packages/tui)
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@itone/fan-tui";
...
```typescript
import { Container, type Focusable, Input } from "@itone/fan-tui";
...
Import from `@itone/fan-tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@itone/fan-tui";
```
...
```typescript
import { matchesKey, Key } from "@itone/fan-tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@itone/fan-tui";
...
import { Markdown } from "@itone/fan-tui";
...
For letting users pick from a list of options. Use `SelectList` from `@itone/fan-tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "@itone/fan-coding-agent";
import { DynamicBorder } from "@itone/fan-coding-agent";
import { Container, type SelectItem, SelectList, Text } from "@itone/fan-tui";
...
```typescript
import { BorderedLoader } from "@itone/fan-coding-agent";
...
For toggling multiple settings. Use `SettingsList` from `@itone/fan-tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "@itone/fan-coding-agent";
import { Container, type SettingItem, SettingsList, Text } from "@itone/fan-tui";
...
import { matchesKey, truncateToWidth } from "@itone/fan-tui";
