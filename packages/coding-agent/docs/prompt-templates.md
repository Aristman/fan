> fan can create prompt templates. Ask it to build one for your workflow.
...
FAN loads prompt templates from:

- Global: `~/.fan/agent/prompts/*.md`
- Project: `.fan/prompts/*.md`
- Packages: `prompts/` directories or `fan.prompts` entries in `package.json`
