...
| `.fan/settings.json` | Project (current directory) |
...
Project settings (`.fan/settings.json`) override global settings. Nested objects are merged:

```json
// ~/.fan/agent/settings.json (global)
{
  "theme": "dark",
  "compaction": { "enabled": true, "reserveTokens": 16384 }
}

// .fan/settings.json (project)
{
