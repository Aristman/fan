...
| Package | Purpose |
|---------|---------|
| `@seaagents/fan-coding-agent` | Extension types (`ExtensionAPI`, `ExtensionContext`, events) |
| `@sinclair/typebox` | Schema definitions for tool parameters |
| `@seaagents/fan-ai` | AI utilities (`StringEnum` for Google-compatible enums) |
| `@seaagents/fan-tui` | TUI components for custom rendering |
...
```typescript
import { withFileMutationQueue } from "@seaagents/fan-coding-agent";
...
**Important:** Use `StringEnum` from `@seaagents/fan-ai` for string enums. `Type.Union`/`Type.Literal` doesn't work with Google's API.
...
- [read.ts](https://github.com/seaagents/fan/blob/main/packages/coding-agent/src/core/tools/read.ts) - `ReadToolDetails`
- [bash.ts](https://github.com/seaagents/fan/blob/main/packages/coding-agent/src/core/tools/bash.ts) - `BashToolDetails`
- [edit.ts](https://github.com/seaagents/fan/blob/main/packages/coding-agent/src/core/tools/edit.ts)
- [write.ts](https://github.com/seaagents/fan/blob/main/packages/coding-agent/src/core/tools/write.ts)
- [grep.ts](https://github.com/seaagents/fan/blob/main/packages/coding-agent/src/core/tools/grep.ts) - `GrepToolDetails`
- [find.ts](https://github.com/seaagents/fan/blob/main/packages/coding-agent/src/core/tools/find.ts) - `FindToolDetails`
- [ls.ts](https://github.com/seaagents/fan/blob/main/packages/coding-agent/src/core/tools/ls.ts) - `LsToolDetails`
...
```typescript
import { createReadTool, createBashTool, type ReadOperations } from "@seaagents/fan-coding-agent";
...
Tools can provide `renderCall` and `renderResult` for custom TUI display. See [tui.md](tui.md) for the full component API and [tool-execution.ts](https://github.com/seaagents/fan/blob/main/packages/coding-agent/src/modes/interactive/components/tool-execution.ts) for how tool rows are composed.
...
```typescript
import { keyHint } from "@seaagents/fan-coding-agent";
...
```typescript
import { Text, Component } from "@seaagents/fan-tui";
...
```typescript
import { CustomEditor, type ExtensionAPI } from "@seaagents/fan-coding-agent";
import { matchesKey } from "@seaagents/fan-tui";
...
```typescript
import { highlightCode, getLanguageFromPath } from "@seaagents/fan-coding-agent";
