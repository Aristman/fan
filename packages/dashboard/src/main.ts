...
function showConnectionSetup(root: HTMLElement): void {
	...
	setup.addEventListener("fan:connected", ((ev: CustomEvent<DashboardConfig>) => {
...
function showToast(message: string): void {
	...
	toast.className = "fixed top-4 right-4 z-50 bg-red-500 text-white px-4 py-2 rounded-lg shadow-lg fade-in text-sm";
