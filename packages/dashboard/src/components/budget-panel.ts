...
export class BudgetPanel extends LitElement {
	...
	private _renderCard(budget: BudgetStatus) {
		...
		const exceededClass = budget.exceeded ? "border-red-500/60" : "border-border";
        ...
        <div>
          <div class="flex items-center justify-between text-xs mb-1">
            ...
            <span class="text-foreground font-mono">
              ...
              ${hasTokenBar ? html` / ${formatTokenCount(budget.tokenLimit!)}` : nothing}
            </span>
          </div>
          ${
					hasTokenBar
        ...
        <div>
          <div class="flex items-center justify-between text-xs mb-1">
            ...
            <span class="text-foreground font-mono">
              ...
              ${hasCostBar ? html` / ${formatCost(budget.costLimit!)}` : nothing}
            </span>
          </div>
          ${
					hasCostBar
