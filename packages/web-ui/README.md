# @seaagents/fan-web-ui

Reusable web UI components for building AI chat interfaces powered by [@seaagents/fan-ai](../ai) and [@seaagents/fan-agent-core](../agent).
...
```bash
npm install @seaagents/fan-web-ui @seaagents/fan-agent-core @seaagents/fan-ai
```
...
import '@seaagents/fan-web-ui/app.css';
...
```typescript
import { defaultConvertToLlm, convertAttachments } from '@seaagents/fan-web-ui';
...
```typescript
import { createJavaScriptReplTool } from '@seaagents/fan-web-ui';
...
```typescript
import { createExtractDocumentTool } from '@seaagents/fan-web-ui';
...
```typescript
import { registerToolRenderer, type ToolRenderer } from '@seaagents/fan-web-ui';
...
```typescript
import { loadAttachment, type Attachment } from '@seaagents/fan-web-ui';
...
```typescript
import { createStreamFn, shouldUseProxyForProvider, isCorsError } from '@seaagents/fan-web-ui';
...
```typescript
import { SettingsDialog, ProvidersModelsTab, ProxyTab, ApiKeysTab } from '@seaagents/fan-web-ui';
...
```typescript
import { SessionListDialog } from '@seaagents/fan-web-ui';
...
```typescript
import { ApiKeyPromptDialog } from '@seaagents/fan-web-ui';
...
```typescript
import { ModelSelector } from '@seaagents/fan-web-ui';
...
```typescript
import { i18n, setLanguage, translations } from '@seaagents/fan-web-ui';
