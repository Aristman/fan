...
Reusable web UI components for building AI chat interfaces powered by [@itone/fan-ai](../ai) and [@itone/fan-agent-core](../agent).
...
```bash
npm install @itone/fan-web-ui @itone/fan-agent-core @itone/fan-ai
```
...
import '@itone/fan-web-ui/app.css';
...
```typescript
import { defaultConvertToLlm, convertAttachments } from '@itone/fan-web-ui';
...
```typescript
import { createJavaScriptReplTool } from '@itone/fan-web-ui';
...
```typescript
import { createExtractDocumentTool } from '@itone/fan-web-ui';
...
```typescript
import { registerToolRenderer, type ToolRenderer } from '@itone/fan-web-ui';
...
```typescript
import { loadAttachment, type Attachment } from '@itone/fan-web-ui';
...
```typescript
import { createStreamFn, shouldUseProxyForProvider, isCorsError } from '@itone/fan-web-ui';
...
```typescript
import { SettingsDialog, ProvidersModelsTab, ProxyTab, ApiKeysTab } from '@itone/fan-web-ui';
...
```typescript
import { SessionListDialog } from '@itone/fan-web-ui';
...
```typescript
import { ApiKeyPromptDialog } from '@itone/fan-web-ui';
...
```typescript
import { ModelSelector } from '@itone/fan-web-ui';
...
```typescript
import { i18n, setLanguage, translations } from '@itone/fan-web-ui';
