import { streamSimple, type ToolResultMessage, type Usage } from "@seaagents/fan-ai";
...
import type { Agent, AgentEvent, UserMessageWithAttachments } from "@seaagents/fan-agent-core";
